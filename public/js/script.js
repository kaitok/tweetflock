  ...
  $(document).ready( function () {
  	var myLatlng = new google.maps.LatLng('28.37', '180.76');
  	var myOptions = {
  		zoom: 2,
  		center: myLatlng,
  ...
  var contentTweet = '<div style="width:200px;height:150px;" class="map_text">' + '<dl><dt><a href="http://twitter.com/'+ data.user['screen_name'] + '" target="_blank">' + 
  '<img src="' + data.user['profile_image_url'] + '" target="_blank">' +
  '</a></dt>' + 
  '<dt>' + data.text + '</dt>' +
  '</dl>' + '</div>';
